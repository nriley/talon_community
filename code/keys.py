...
default_alphabet = "air bat cap drum each fine gust harp sit jury crunch look made near odd pit quench red sun trap urge vest whale plex yank zoo".split(
    " "
)
...
if app.platform == "mac":
    ...
    # I keep getting "comma" or "coma" when I say "command"
